...
public class UserRepository {
	...
	public boolean existsByusername(String username) {
		Integer cnt = jdbcTemplate.queryForObject("Select count(*) from users where username =?", Integer.class,
				username);
	...
	public int save(User user) {
		return jdbcTemplate.update("Insert into users (username, password, role) Values (?,?,?)", user.getUsername(),
