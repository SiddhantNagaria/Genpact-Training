...
public class HotelDaoImpl implements HotelDao {
	...
	public int update(Hotel hotel) {
		...
		return jdbcTemplate.update(sql, hotel.getName(), hotel.getAddress(), hotel.getTotal_rooms(),
				hotel.getAvailable_rooms(), hotel.getPrice_per_night(), hotel.getId());
	}
	...
	public List<Hotel> searchByName(String name) {
		...
		return jdbcTemplate.query(sql, new HotelRowMapper(), pattern);
	}
